...
\thesisdate{31 de Julho de 2008}  % comment for today in provisional versions
...
%% Uncomment next lines in the final version
\committeetext{Aprovado em provas públicas pelo Júri:}
\committeemember{Presidente}{Doutor Nome do Presidente}
\committeemember{Vogal Externo}{Doutor Nome do Arguente}
\committeemember{Orientador}{Doutor Nome do Orientador}
\signature
